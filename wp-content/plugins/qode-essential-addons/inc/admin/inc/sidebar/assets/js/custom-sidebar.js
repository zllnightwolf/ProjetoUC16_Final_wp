			...
			$addButton.on(
				...
				function ( e ) {
					...
					var sidebarName     = holder.find( '.qodef-custom-sidebar-name' ),
						nonce           = holder.find( '#qode_essential_addons_framework_nonce_custom_sidebar' ),
					...
					$.ajax(
						{
							...
							url: ajaxurl,
							data: {
								action: 'qode_essential_addons_framework_add_custom_sidebar',
					...
					$.ajax(
						{
							...
							url: ajaxurl,
							data: {
								action: 'qode_essential_addons_framework_delete_custom_sidebar',
								name: name,
								nonce: nonce.val()
							},
							success: function ( data ) {
