(function ( $ ) {
	...
	$( window ).resize(
		function () {
			...
			if ( qodefFramework.windowWidth > 600 &&
				typeof qodefFramework.qodefAdminOptionsPanel.adminPage !== 'undefined' &&
				qodefFramework.qodefAdminOptionsPanel.adminPage.length) {
				qodefFramework.qodefAdminOptionsPanel.adminHeader.width( qodefFramework.qodefAdminOptionsPanel.adminPage.width() );
			}
		}
	);
	...
	qodefFramework.qodefAdminOptionsPanel = qodefAdminOptionsPanel;
