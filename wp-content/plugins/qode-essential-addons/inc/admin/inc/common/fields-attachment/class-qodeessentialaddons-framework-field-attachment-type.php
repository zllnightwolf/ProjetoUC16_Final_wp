...
abstract class QodeEssentialAddons_Framework_Field_Attachment_Type {
	...
	function __construct( $params ) {
		...
		$value           = qode_essential_addons_framework_get_option_value( '', $this->type, $this->name, $this->default_value, $this->post_id );
		$params['value'] = $value;
