...
class QodeEssentialAddons_Framework_Field_Repeater_Inner implements QodeEssentialAddons_Framework_Tree_Interface, QodeEssentialAddons_Framework_Child_Interface {
								...
								<div class="qodef-repeater-inner-fields-holder qodef-second-level clearfix" data-index="<?php echo esc_attr( $counter ); ?>">
									...
									<div class="qodef-repeater-actions-holder">
										...
										<div class="qodef-repeater-remove">
											<a class="qodef-clone-inner-remove" href="#"><?php qode_essential_addons_framework_svg_icon( 'trash' ); ?></a>
										</div>
									</div>
								</div>
								<?php
