...
abstract class QodeEssentialAddons_Framework_Shortcode {
	...
	private function merge_option_atts( $params ) {
		...
		$this->option_atts                    = qode_essential_addons_framework_map_shortcode_fields( $default_options, $params );
	}
	...
	public function get_editor_content( $content, $options ) {
		return apply_filters( 'qode_essential_addons_filter_framework_shortcode_content_html', $content, $options );
	}
	...
	public function parse_repeater_items( $items ) {
		...
		return apply_filters( 'qode_essential_addons_filter_framework_parse_repeater_items', $items_formatted );
	}
	...
	public function init_holder_classes() {
		...
		$holder_classes = apply_filters( 'qode_essential_addons_filter_framework_shortcode_holder_classes', $holder_classes );
	...
	public function init_item_classes() {
		...
		$item_classes   = apply_filters( 'qode_essential_addons_filter_framework_shortcode_item_classes', $item_classes );
	...
	public function import_shortcode_options( $params ) {
		...
		$options_to_skip         = apply_filters( 'qode_essential_addons_filter_framework_shortcode_options_import_skip', array( 'dependency' ) );
