...
abstract class QodeEssentialAddons_Framework_Field_Widget_Type {
	...
	public function load_assets() {
		do_action( 'qode_essential_addons_action_framework_field_widget_type_load_assets', $this->field_type );
	}
