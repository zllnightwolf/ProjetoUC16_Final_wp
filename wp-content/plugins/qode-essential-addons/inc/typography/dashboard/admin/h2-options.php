...
if ( ! function_exists( 'qode_essential_addons_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function qode_essential_addons_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'qode-essential-addons' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'qode-essential-addons' ),
				)
			);
			...
			do_action( 'qodef_essential_addons_filter_end_of_h2_typography_options', $h2_typography_row );
	...
	add_action( 'qode_essential_addons_action_after_typography_options_map', 'qode_essential_addons_add_h2_typography_options' );
}
