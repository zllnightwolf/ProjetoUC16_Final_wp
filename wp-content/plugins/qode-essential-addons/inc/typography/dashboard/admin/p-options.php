...
if ( ! function_exists( 'qode_essential_addons_add_p_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function qode_essential_addons_add_p_typography_options( $page ) {
		...
		if ( $page ) {
			$paragraph_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-paragraph',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Paragraph Typography', 'qode-essential-addons' ),
					'description' => esc_html__( 'Set values for paragraph', 'qode-essential-addons' ),
				)
			);
			...
			do_action( 'qodef_essential_addons_filter_end_of_p_typography_options', $p_typography_row );
	...
	add_action( 'qode_essential_addons_action_after_typography_options_map', 'qode_essential_addons_add_p_typography_options' );
}
