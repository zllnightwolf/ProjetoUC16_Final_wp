...
if ( ! function_exists( 'qode_essential_addons_add_h3_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function qode_essential_addons_add_h3_typography_options( $page ) {
		...
		if ( $page ) {
			$h3_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h3',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H3 Typography', 'qode-essential-addons' ),
					'description' => esc_html__( 'Set values for Heading 3 HTML element', 'qode-essential-addons' ),
				)
			);
			...
			do_action( 'qodef_essential_addons_filter_end_of_h3_typography_options', $h3_typography_row );
	...
	add_action( 'qode_essential_addons_action_after_typography_options_map', 'qode_essential_addons_add_h3_typography_options' );
}
