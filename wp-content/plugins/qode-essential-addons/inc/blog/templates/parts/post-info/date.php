...
<div itemprop="dateCreated" class="qodef-e-info-item qodef-e-info-date entry-date <?php echo esc_attr( $classes ); ?>">
	<a itemprop="url" href="<?php echo esc_url( $date_link ); ?>"><?php qode_essential_addons_render_svg_icon( 'date', 'qodef-e-info-item-icon' ); ?><?php the_time( get_option( 'date_format' ) ); ?></a>
</div>
